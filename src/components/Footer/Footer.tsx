    ...
    <footer className="bg-accent tracking-wide pt-12">
        ...
        <div className="grid max-sm:grid-cols-1 max-lg:grid-cols-2 lg:grid-cols-4 gap-8 px-10">
            <div className='flex flex-col items-start gap-6'>
                ...
                <p className="text-slate-200 mb-2 text-sm">At <span className='font-semibold'>Dentistry</span>, we are dedicated to providing exceptional, personalized dental care in a compassionate and welcoming environment.
                </p>
                </div>
            ...
            <ul className="space-y-4">
                {
                    services.map((item)=>(
                    <li key={item.id}>
                        <a href="#" className="text-white hover:text-gray-800 text-[15px]">
                            {item.title}
                        </a>
                    </li>
                    ))
